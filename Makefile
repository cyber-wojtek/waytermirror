...
LIBS = -lwayland-client -lm -lz -llz4 -lpthread -linput -ludev -lpipewire-0.3 -L/opt/cuda/lib64 -lcudart
...
waytermirror_server: waytermirror_server.o $(PROTOCOLS_O) braille_renderer_cuda.o
